...
students = []
with open("D:/Desktop/students.csv", 'r') as csvfile:
    csvreader = csv.DictReader(csvfile)
    for row in csvreader:
        students.append(row)

with open("D:/Desktop/students.json", 'w') as jsonfile:
...
with open("D:/Desktop/data.json", 'r') as jsonfile:
    data = json.load(jsonfile)

with open("D:/Desktop/data.csv", 'w', newline='') as csvfile:
